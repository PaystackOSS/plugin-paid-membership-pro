...
* Search the [Existing Issues](https://github.com/PaystackHQ/wordpress-paid-membership-pro-paystack/issues) to be sure that the one you've noticed isn't already there
